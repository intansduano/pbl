   ...
   <section class="bg-gray-50 min-h-screen flex items-center justify-center">
    ...
    <div class="bg-[#7ad3f62a] flex rounded-2xl shadow-lg max-w-3xl p-4">
        ...
        <div class="sm:w-1/2 px-16">
            ...
            <p class="text-sm mt-7 text-[#6c57b1] text-opacity-70 text-center">Masukan <i>email</i> aktif dan  <i>password</i> yang telah terdaftar pada sistem.</p>

            <!--Data entry group-->
            <form class="flex flex-col gap-4" method="POST" action="">
                <input class="p-2 mt-8 rounded-xl border" type="text" name="email" placeholder="intan.duano@example.com">
                <div class="relative">
                    <input id="password" class="p-2 mt-8 rounded-xl border w-full" type="password" name="password" placeholder="Input password...">

                    <!--SVG Eye-->
                    <svg onclick="showpass()" class="bi bi-eye-fill absolute top-1/2 right-4 
...
<!-- 
            ...
            <div class="mt-3 text-xs flex justify-between items-cente">
                ...
                <button class="py-2 px-5 bg-white border rounded-xl">Registrasi</button>
